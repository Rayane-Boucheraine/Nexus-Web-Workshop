...
const Page: React.FC = () => {
  ...
  return (
    <div className="relative flex items-center justify-center w-[100vw] h-[100vh] overflow-hidden bg-gradient-to-b from-[#232323] to-[#181717]">
      ...
      />
      <div className="relative flex gap-6 flex-col h-[400px] px-[30px] py-[26px] w-[40%] z-[50] rounded-[24.369px] bg-white/90 backdrop-blur-[calc(var(--sds-size-depth-400)_/_2)]">
        <div className="flex items-center justify-between w-[100%]">
          <h2 className="text-[#76E494] font-[800] text-[24px]">
            Your Profile
          </h2>
          <Link
